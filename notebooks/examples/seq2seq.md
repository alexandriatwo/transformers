...
For custom datasets in `jsonlines` format please see: [https://huggingface.co/docs/datasets/loading\_datasets.html\#json-files](https://huggingface.co/docs/datasets/loading_datasets.html#json-files) and you also will find examples of these below.
