...
By default, RAG uses the English Wikipedia as a knowledge source, known as the 'wiki\_dpr' dataset. With `use_custom_knowledge_dataset.py` you can build your own knowledge source, _e.g._ for RAG.
