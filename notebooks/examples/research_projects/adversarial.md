...
This is an example of using test\_hans.py:
...
This will create the hans\_predictions.txt file in MODEL\_PATH, which can then be evaluated using hans/evaluate\_heur\_output.py from the HANS dataset.
